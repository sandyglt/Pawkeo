...
ActiveRecord::Schema.define(version: 2019_06_12_131544) do
  ...
  create_table "spots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "my_spot", default: false, null: false
  end
  ...
  add_foreign_key "spot_searches", "spots"
  add_foreign_key "spot_searches", "users"
end
